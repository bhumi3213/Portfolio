        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 items-center">
            ...
            >
              ...
              >
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-fuchsia-600 dark:from-indigo-400 dark:to-fuchsia-400">UI/UX Designerr</span>
              </motion.div>
              
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold leading-tight text-gray-900 dark:text-white">
                Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-fuchsia-600 dark:from-indigo-400 dark:via-purple-400 dark:to-fuchsia-400">Bhumi Sagar</span>
              </h1>
              
              <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 max-w-xl leading-relaxed">
                I'm a UI/UX Designer From Ahmedabad, Crafting Intuitive, User-Focused Digital Experinces.
              </p>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                >
                  ...
                  <FiArrowDown className="relative z-10 group-hover:translate-x-1 transition-transform" />
              ...
              <div className="flex gap-4 pt-6">
                ...
                <a 
                  href="https://www.linkedin.com/in/bhumi-sagar-068935350/" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="p-2 bg-white/70 backdrop-blur-sm rounded-full text-gray-700 hover:text-indigo-600 hover:bg-white transition-colors dark:bg-gray-800/50 dark:text-gray-300 dark:hover:text-indigo-400 dark:hover:bg-gray-800"
                >
                ...
                <a 
                  href="https://www.behance.net/bhumisagar/" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="p-2 bg-white/70 backdrop-blur-sm rounded-full text-gray-700 hover:text-indigo-600 hover:bg-white transition-colors dark:bg-gray-800/50 dark:text-gray-300 dark:hover:text-indigo-400 dark:hover:bg-gray-800"
                >
            ...
            >
              <div className="relative w-72 h-72 md:w-96 md:h-96 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                ...
                <div className="absolute -bottom-6 right-6 bg-white/90 dark:bg-gray-800/90 rounded-lg px-5 py-3 shadow-lg backdrop-blur-sm z-20 border border-gray-100 dark:border-gray-700 transform -rotate-3">
                  <p className="text-sm font-medium text-gray-900 dark:text-gray-100">UI/UX</p>
                  <p className="text-xs text-indigo-600 dark:text-indigo-400">Designer</p>
                </div>
