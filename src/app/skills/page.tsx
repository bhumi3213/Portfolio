...
import { SiFigma, SiAdobexd, SiAdobephotoshop, SiAdobeillustrator, SiCanva } from "react-icons/si";
...
const CATEGORIES = [
  {
    ...
    description: 'Creative Tools Product Web and UI/UX Design'
  },
  {
    id: 'UIUX',
    name: 'UIUX',
    icon: <FiLayers className="w-5 h-5" />,
    description: 'Designing Seamless Digital Experiences by Combining Creativity, Usability, and Strategy'
  },
  // {
  //   id: 'databases',
...
function getSkillIcon(name: string) {
  const iconMap: Record<string, JSX.Element> = {
    ...
    'Adobe XD': <SiAdobexd className="w-6 h-6" />,
    'Adobe Photoshop': <SiAdobephotoshop className="w-6 h-6" />,
    'Adobe Illustrator': <SiAdobeillustrator className="w-6 h-6" />,
    // 'Motiff': <SiMotiff className="w-6 h-6" />,
...
export default function SkillsPage() {
  ...
  const skillsData = {
    Design_Tools: [
      { 
        name: "Figma", 
        icon: <SiFigma />,  // added icon with color + size
        level: "Advanced", 
        year: "2025", 
        description: "Learned During The Training Period of The UI/UX Design Course.",
        projects: ["Hospital Management (Admin Panel)", "Detailed Feature analysis Of The Uber Application"]
      },
      { 
        name: "Adobe XD", 
        icon: <SiAdobexd />, 
      ...
      { 
        ...
        year: "2025", 
        description: "Learned During The Training Period of The UI/UX Design Course.",
        projects: ["Brew Heaven Coffee Shop App UI/UX Case Study"]
      },
      { 
        name: "Canva",
        icon: <SiCanva />, 
        level: "Advanced", 
        year: "2025", 
        description: "Learned When Working On Projects.",
        projects: ["Creating Banner, Logo's, Resume"]
      },
    ],
    UIUX: [
      { 
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <div className="relative bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 border-b border-gray-200 dark:border-gray-800 overflow-hidden py-16">
        ...
        <div className="absolute opacity-20 -left-3 top-10 text-5xl font-mono text-indigo-500 dark:text-indigo-400 tracking-tight hidden md:block">
          &lt;Graphic Design&gt;
        </div>
        <div className="absolute opacity-20 -right-3 bottom-10 text-5xl font-mono text-indigo-500 dark:text-indigo-400 tracking-tight hidden md:block">
          &lt;UI/UX&gt;
        </div>
        
        {/* Floating tech icons */}
        <motion.div 
          className="absolute bottom-10 right-1/4 opacity-10 text-4xl text-indigo-600 dark:text-indigo-400"
        ...
        >
         ...
         <motion.div 
          className="absolute top-1/3 left-1/4 opacity-10 text-4xl text-green-600 dark:text-green-400"
          animate={{ y: [0, 8, 0], rotate: [0, 3, 0] }}
          transition={{ repeat: Infinity, duration: 6, ease: "easeInOut", delay: 0.5 }}
        >
          <SiAdobephotoshop />
