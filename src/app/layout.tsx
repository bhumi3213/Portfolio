...
export const metadata: Metadata = {
  ...
  description: 'Professional portfolio of Bhumi Sagar, UI/UX Designer.',
  icons: {
    icon: "/favicon.ico",
  ...
  openGraph: {
    title: "Bhumi's Portfolio",
    description: 'Professional portfolio of Bhumi Sagar, UI/UX Designer.',
    url: 'https://bhumi.works',
    siteName: "Bhumi's Portfolio",
    
    images: [{
      url: "https://bhumi.works/images/bhumi.jpeg",
      width: 1200,
      height: 630,
  ...
  twitter: {
    ...
    images: ["https://bhumi.works/images/bhumi.jpeg"],
  },
}
